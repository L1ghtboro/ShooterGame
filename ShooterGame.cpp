...
task<void> ShooterGame::LoadLevelAsync()
{
...
void ShooterGame::FinalizeLoadLevel()
{
    m_renderer->FinalizeLoadLevelResources();
}

void ShooterGame::StartLevel()
{
    m_timer->Reset();
    m_timer->Start();
    if (m_currentLevel == 0)
...
void ShooterGame::PauseGame()
{
    m_timer->Stop();
    SaveState();
}

void ShooterGame::ContinueGame()
{
    m_timer->Start();
    m_controller->Active(true);
}

GameState ShooterGame::RunGame()
{
...
void ShooterGame::OnSuspending()
{
    m_audioController->SuspendAudio();
}

void ShooterGame::OnResuming()
{
    m_audioController->ResumeAudio();
}

void ShooterGame::UpdateDynamics()
{
...
void ShooterGame::SetCurrentLevelToSavedState()
{
    if (m_gameActive)
    {
        if (m_levelActive)
...
void ShooterGame::SaveHighScore()
{
...
void ShooterGame::LoadHighScore()
{
...
void ShooterGame::InitializeAmmo()
{
    m_ammoCount = 0;
    m_ammoNext = 0;
